...
if(empty($_POST['go'])):
    ...
    if(isset($_POST['number'])) {
        ...
        if (strlen( $number ) == 0){
            $error2 = "Telefon numaranızı girin";
        }
    }
...
if (isset($_POST['nickname']) && isset($_POST['number'])) {
    ...
    if ((strlen($nickname) == 0) || (strlen($number) == 0)) {
        echo "<script> alert('". "İleti gönderilmedi" ." ')</script>";
    }
    else {
        (mail($to, $subject, $message, $headers));
        echo  "<script> alert('". "Mesajın gönderildiği" ." ')</script>";
    }
}
...
if(empty($_POST['go'])):
    ...
    if(isset($_POST['phone'])) {
        ...
        if (strlen( $phone ) == 0){
            $error5 = "Telefon numaranızı girin";
        }
    }
